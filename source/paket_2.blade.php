...
@section('body')
    <div class="max-w-screen-2xl mx-auto">
        ...
        <div class="max-w-screen-2xl bg-nav-orange fixed top-16 z-50 w-full py-2 justify-between flex flex-row text-sm">
            <p class="w-full text-center">Apabila anda telah melakukan <b>transfer</b>, mohon klik <b>tombol konfirmasi pembayaran</b>, agar kami bisa melakukan <b>konfirmasi pembayaran</b> anda.</p>
        </div>
...
{{--        main--}}
        ...
        <div class="px-5 pb-10 pt-40 lg:px-32 lg:pt-40 lg:pb-28">
